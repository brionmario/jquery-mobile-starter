...
<body>
<div data-role="page">
  <div role="main" class="overlay ui-content">
    <div class="ui-grid-a ui-responsive">
      <div class="app-container">
        <div class="app-content">
          <iframe width="375" height="667" src="demo.php" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
        </div>
      </div>
    </div><!-- /grid-a -->
  </div><!-- /content -->
